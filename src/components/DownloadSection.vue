        ...
        <v-col cols="10">
          <v-row align="center" justify="center">
            ...
            <v-col cols="12" sm="8" class="white--text text-left">
              <h1 class="font-weight-light display-2 mb-2">Demonstrações</h1>
              ...
              <v-btn rounded outlined href="https://github.com/Wenykeny" target="_blank" large color="white" class="mt-4">
                <v-icon class="mr-2">
                  mdi-github
                </v-icon>
                Git Hub
