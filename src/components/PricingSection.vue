              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">Kz 150.000,00</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text-uppercase blue--text">Outras características...</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">Kz 250.000,00</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text-uppercase blue--text">Outras características...</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">Kzs 500.000,00</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
